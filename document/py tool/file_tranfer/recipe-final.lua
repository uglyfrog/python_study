...
util.conditional_modify({
  ...
  normal = {
    ingredients = {
      ...
      {type="item", name="basic-circuit", amount=10},
      {type="item", name="electric-motor", amount=5}
    }
  },
  expensive = {
    ingredients = {
      ...
      {type="item", name="stone-brick", amount=30},
      {type="item", name="basic-circuit", amount=20},
      {type="item", name="electric-motor", amount=10}
    }
  }
})
...
if data.raw.recipe["logistic-science-pack"]
  and data.raw.recipe["logistic-science-pack"].ingredients
