...
data_util.tech_add_ingredients("energy-shield-mk2-equipment", {data_util.mod_prefix .. "energy-science-pack-2"}, true)
...
data_util.tech_add_ingredients("energy-shield-mk3-equipment", {data_util.mod_prefix .. "energy-science-pack-3"}, true)
