    ...
    data:extend({
      {
        ...
        upgrade = true,
        prerequisites = {
          i == 5 and (data_util.mod_prefix .. "deep-space-science-pack-1") or (data_util.mod_prefix .. "biological-science-pack-"..math.min(4,i)),
        ...
        unit = {
         ...
         ingredients = {
           ...
           i == 5 and { data_util.mod_prefix .. "deep-space-science-pack-1", 1 } or nil,
         }
        },
      },
    })
