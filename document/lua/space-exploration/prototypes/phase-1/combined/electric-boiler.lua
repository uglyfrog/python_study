        ...
        {
          {
            north_animation =
            {
              ...
              {
                {
                  filename = "__space-exploration-graphics__/graphics/entity/electric-boiler/electric-boiler-n-light.png",
                  priority = "extra-high",
                  width = 268/2,
                  height = 220/2,
                  shift = util.by_pixel(-1.25, 5.25),
                  blend_mode = "additive",
                  data_util.hr({
                    filename = "__space-exploration-hr-graphics__/graphics/entity/electric-boiler/hr-electric-boiler-n-light.png",
                    width = 268,
                    height = 220,
                    priority = "extra-high",
                    shift = util.by_pixel(-1.25, 5.25),
            ...
            east_animation =
            {
              ...
              {
                {
                  filename = "__space-exploration-graphics__/graphics/entity/electric-boiler/electric-boiler-e-light.png",
                  priority = "extra-high",
                  width = 210/2,
                  height = 300/2,
                  shift = util.by_pixel(-1.75, 1.25),
                  blend_mode = "additive",
                  data_util.hr({
                    filename = "__space-exploration-hr-graphics__/graphics/entity/electric-boiler/hr-electric-boiler-e-light.png",
                    width = 210,
                    height = 300,
                    priority = "extra-high",
                    shift = util.by_pixel(-1.75, 1.25),
            ...
            south_animation =
            {
              ...
              {
                {
                  filename = "__space-exploration-graphics__/graphics/entity/electric-boiler/electric-boiler-s-light.png",
                  priority = "extra-high",
                  width = 260/2,
                  height = 200/2,
                  shift = util.by_pixel(4, 10.75),
                  blend_mode = "additive",
                  data_util.hr({
                    filename = "__space-exploration-hr-graphics__/graphics/entity/electric-boiler/hr-electric-boiler-s-light.png",
                    width = 260,
                    height = 200,
                    priority = "extra-high",
                    shift = util.by_pixel(4, 10.75),
            ...
            west_animation =
            {
              ...
              {
                {
                  filename = "__space-exploration-graphics__/graphics/entity/electric-boiler/electric-boiler-w-light.png",
                  priority = "extra-high",
                  width = 196/2,
                  height = 272/2,
                  shift = util.by_pixel(1.5, 7.75),
                  blend_mode = "additive",
                  data_util.hr({
                    filename = "__space-exploration-hr-graphics__/graphics/entity/electric-boiler/hr-electric-boiler-w-light.png",
                    width = 196,
                    height = 272,
                    priority = "extra-high",
                    shift = util.by_pixel(1.5, 7.75),
