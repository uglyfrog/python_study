    ...
    picture =
    {
      layers =
      {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/linked-container/hr-linked-container.png",
          width = 132,
          height = 136,
          shift = {0, 0/32},
          scale = 0.5
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/linked-container/hr-linked-container-shadow.png",
          width = 132,
          height = 88,
          shift = {13/32, 9/32},
          scale = 0.5
