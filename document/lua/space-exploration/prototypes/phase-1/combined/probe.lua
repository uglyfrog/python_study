...
data:extend({
  ...
  },
  {
    ...
    base_day_sprite = {layers = {
      ...
      {
        filename = "__space-exploration-graphics__/graphics/entity/probe/sr/06-rocket-silo-mask.png",
        width = 608/2,
        height = 596/2,
        shift = util.by_pixel(3, -1),
        ...
        hr_version =
        data_util.hr({
          filename = "__space-exploration-hr-graphics__/graphics/entity/probe/hr/06-rocket-silo-mask.png",
          width = 608,
          height = 596,
          shift = util.by_pixel(3, -1),
          tint = {r=0.4,b=0.9,g=0.6},
    ...
    base_front_sprite = {
      layers = {
        ...
        {
          filename = "__space-exploration-graphics__/graphics/entity/probe/sr/14-rocket-silo-front-mask.png",
          width = 580/2,
          height = 262/2,
          shift = util.by_pixel(-1, 78),
          tint = {r=0.4,b=0.9,g=0.6},
          hr_version =
          data_util.hr({
            filename = "__space-exploration-hr-graphics__/graphics/entity/probe/hr/14-rocket-silo-front-mask.png",
            width = 580,
            height = 262,
            shift = util.by_pixel(-1, 78),
            tint = {r=0.4,b=0.9,g=0.6},
  ...
  },
  {
    ...
    {
      filename = "__space-exploration-graphics__/graphics/entity/probe/sr/probe-rocket.png",
      width = 310/2,
      height = 596/2,
      shift = util.by_pixel(-5, -27),
      hr_version = data_util.hr({
        filename = "__space-exploration-hr-graphics__/graphics/entity/probe/hr/probe-rocket.png",
        width = 310,
        height = 596,
        shift = util.by_pixel(-5, -27),
        scale = 0.5
