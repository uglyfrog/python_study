...
data:extend({
...

  {
    ...
    animation =
    {
      layers = {
        {
            filename = "__space-exploration-graphics__/graphics/entity/delivery-cannon/delivery-cannon-weapon.png",
            shift = { 0, -4.75 },
            width = 616/2,
            height = 1198/2,
            hr_version = data_util.hr({
                filename = "__space-exploration-hr-graphics__/graphics/entity/delivery-cannon/hr-delivery-cannon-weapon.png",
                shift = { 0, -4.75 },
                width = 616,
                height = 1198,
                scale = 0.5,
        ...
        {
            draw_as_shadow = true,
            filename = "__space-exploration-graphics__/graphics/entity/delivery-cannon/delivery-cannon-weapon-shadow.png",
            shift = { 2.5, 2/32 },
            width = 890/2,
            height = 578/2,
            hr_version = data_util.hr({
                draw_as_shadow = true,
                filename = "__space-exploration-hr-graphics__/graphics/entity/delivery-cannon/hr-delivery-cannon-weapon-shadow.png",
                shift = { 2.5, 2/32 },
                width = 890,
                height = 578,
                scale = 0.5,
  ...
  },
  {
    ...
    animations = {
      {
        filename = "__space-exploration-graphics__/graphics/entity/delivery-cannon/delivery-cannon-weapon-beam.png",
        frame_count = 6,
        height = 1,
        priority = "extra-high",
        width = 187
  ...
  },
  {
    ...
    rotatable = false,
    animation = {
      filename = "__space-exploration-graphics__/graphics/entity/delivery-cannon/delivery-cannon-weapon-capsule.png",
      frame_count = 1,
      width = 58/2,
      height = 94/2,
      line_length = 1,
      ...
      shift = { 0, 0 },
      data_util.hr({
        filename = "__space-exploration-hr-graphics__/graphics/entity/delivery-cannon/hr-delivery-cannon-weapon-capsule.png",
        frame_count = 1,
        width = 58,
        height = 94,
        line_length = 1,
