...
data:extend({
...

  {
    ...
    animation =
    {
      ...
      {
        {
          filename = "__space-exploration-graphics__/graphics/entity/supercomputer/sr/supercomputer-4.png",
          priority = "high",
          width = 320/2,
          height = 384/2,
          frame_count = 1,
          ...
          animation_speed = 1,
          hr_version = {
            filename = "__space-exploration-graphics__/graphics/entity/supercomputer/hr/supercomputer-4.png",
            priority = "high",
            width = 320,
            height = 384,
            frame_count = 1,
    ...
    working_visualisations =
    {
      ...
      {
        animation = {
          filename = "__space-exploration-graphics__/graphics/entity/supercomputer/sr/supercomputer-4-working.png",
          priority = "high",
          width = 560/4/2,
          height = 1184/4/2,
          line_length = 4,
          ...
          max_advance = 1,
          hr_version = {
            filename = "__space-exploration-graphics__/graphics/entity/supercomputer/hr/supercomputer-4-working.png",
            priority = "high",
            width = 560/4,
            height = 1184/4,
            line_length = 4,
