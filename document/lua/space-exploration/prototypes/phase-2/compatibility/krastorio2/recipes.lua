...
rare_metals_vulcanite.icons = {
  {icon = data.raw.item["rare-metals"].icon, icon_size = data.raw.item["rare-metals"].icon_size, scale = 32/data.raw.item["rare-metals"].icon_size},
...
silicon_vulcanite.icons = {
  {icon = data.raw.item["silicon"].icon, icon_size = data.raw.item["silicon"].icon_size, scale = 32/data.raw.item["silicon"].icon_size},
  {icon = data.raw.item[data_util.mod_prefix .. "vulcanite-block"].icon,
    icon_size = data.raw.item[data_util.mod_prefix .. "vulcanite-block"].icon_size,
    scale = 0.5 * 32/data.raw.item[data_util.mod_prefix .. "vulcanite-block"].icon_size,
    shift = {-10, -10}
