...
function Landingpad.gui_open(player, landing_pad)
  ...
  local rename_button = name_flow.add{ type = "sprite-button", name="rename", sprite="utility/rename_icon_normal", tooltip={"space-exploration.rename-something", {"entity-name." .. Landingpad.name_rocket_landing_pad}}, style="space_platform_sprite_button_small"}
