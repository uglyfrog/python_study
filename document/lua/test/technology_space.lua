...
if not data.raw.technology["sand-processing"] then
  data:extend({{
      ...
      order = "a",
      prerequisites = {
      }, -- if basic automation existed from AAI Industry then this would not fire anyway
      unit = {
          count = 10,
          ingredients = {
...
data:extend({
  ...
  },
  {
    ...
    effects = {
      ...
      { type = "unlock-recipe", recipe = data_util.mod_prefix .. "space-dialation-data" },
      { type = "unlock-recipe", recipe = data_util.mod_prefix .. "space-dialation-data-alt" },
...
data:extend{
    {
        ...
        order = "c-k-m",
        prerequisites = { 
            "toolbelt", "logistic-science-pack",
        },
        effects = {
            {  recipe = "character-inventory-slots-bonus" }
        },
        unit = {
            count = 100,
            ingredients = {
    ...
    },
    {
        ...
        order = "c-k-m",
        prerequisites = {
            "toolbelt-2", "chemical-science-pack",
        },
        effects = {
            {  recipe = "character-inventory-slots-bonus" }
        },
    ...
    },
    {
        ...
        order = "c-k-m",
        prerequisites = {
            "toolbelt-3", "utility-science-pack",
        },
        effects = {
            {  recipe = "character-inventory-slots-bonus" }
        },
    ...
    },
    {
        ...
        order = "c-k-m",
        prerequisites = {
            "toolbelt-4", "production-science-pack",
        },
        effects = {
            {  recipe = "character-inventory-slots-bonus" }
        },
    ...
    },
    {
        ...
        order = "a",
        prerequisites = {
            "concrete-walls", "military-science-pack",
        },
        effects = {
    ...
    },
    {
        ...
        order = "a",
        prerequisites = {
            "steel-processing", "electricity", "logistic-science-pack",
        },
        effects = {
...

{
    ...
    },
    {
...

     {
          ...
          effects = {
            { recipe = data_util.mod_prefix.."space-probe-rocket-silo"},
            { recipe = data_util.mod_prefix.."space-probe-rocket" },
          },
  ...
  },
  {
    ...
    effects = {
      { recipe = data_util.mod_prefix .. "arcosphere-fracture", },
      { recipe = data_util.mod_prefix .. "arcosphere-fracture-alt", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-in", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-out", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-a", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-b", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-c", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-d", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-e", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-f", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-g", },
      { recipe = data_util.mod_prefix .. "arcosphere-fold-h", },
    },
    icon = "__space-exploration-graphics__/graphics/technology/arcosphere.png",
    icon_size = 128,
    order = "e-g",
...

  {
...

    {
        ...
        effects = {
          ...
          { recipe = data_util.mod_prefix .. "electric-boiling-void" },
          { recipe = data_util.mod_prefix .. "electric-boiling-steam-100" },
          { recipe = data_util.mod_prefix .. "electric-boiling-steam-165" },
          { recipe = data_util.mod_prefix .. "electric-boiling-steam-500" },
          { recipe = data_util.mod_prefix .. "electric-boiling-steam-5000" },
          { recipe = data_util.mod_prefix .. "steam-to-water" },
        },
...

 {
...

  {
...

    {
        ...
        effects = {
          { recipe = data_util.mod_prefix .. "spaceship-clamp" },
        },
...

{
    ...
    effects = {
        {recipe = data_util.mod_prefix .. "deep-space-transport-belt"},
        {recipe = data_util.mod_prefix .. "deep-space-splitter"},
        {recipe = data_util.mod_prefix .. "deep-space-underground-belt"},
    },
...

  {
      ...
      effects = {
        { recipe = data_util.mod_prefix .. "biogun" },
        { recipe = data_util.mod_prefix .. "bloater-ammo" },
        { recipe = data_util.mod_prefix .. "pheromone-ammo" },
      },
