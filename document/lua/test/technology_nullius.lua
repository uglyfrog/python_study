...
data:extend({
  ...
  },
  {
    ...
    unit = {
      count = 50,
      ingredients = {
        {"nullius-biochemistry-pack", 2},
        {"nullius-microbiology-pack", 1}
      },
      time = 600
    },
