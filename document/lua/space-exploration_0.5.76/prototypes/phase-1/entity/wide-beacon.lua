    ...
    animation = {
      layers = {
        data_util.auto_sr_hr({
          animation_speed = 0.5,
          filename = "__space-exploration-graphics-4__/graphics/entity/wide-beacon/hr/wide-beacon.png",
          frame_count = 32,
          width = 256,
          height = 320,
          line_length = 8,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          animation_speed = 0.5,
          filename = "__space-exploration-graphics-4__/graphics/entity/wide-beacon/hr/wide-beacon-shadow.png",
          frame_count = 32,
          width = 330,
          height = 174,
          line_length = 4,
  ...
  },
  {
    ...
    animation = {
      layers = {
        data_util.auto_sr_hr({
          animation_speed = 0.5,
          filename = "__space-exploration-graphics-4__/graphics/entity/wide-beacon/hr/wide-beacon-2.png",
          frame_count = 32,
          width = 256,
          height = 320,
          line_length = 8,
