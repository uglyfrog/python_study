...
for i = 1, 64, 1 do
  local track = {
    ...
    picture = {
      ...
      scale = 0.135*2,
      hr_version = {
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/glyphs-a-energy.png",
        width = 2048/8,
        height = 1536/8,
        x = ((i-1)%8)*2048/8,
  ...
  data:extend({
    {
      ...
      localised_name = {"entity-name.se-gate-part"},
      ...
      picture = data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/main-"..m..".png",
        width = dimensions[1],
        height = dimensions[2],
        shift = {0,0},
        scale = 0.5,
  ...
  data:extend({
    {
      ...
      picture = data_util.auto_sr_hr({
        draw_as_shadow = true,
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/main-"..m.."-shadow.png",
        width = dimensions[1],
        height = dimensions[2],
        shift = {0,0},
        scale = 0.5,
  ...
  data:extend({
    {
      ...
      selectable_in_game = false,
      picture = data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/underlay-"..u..".png",
        width = dimensions[1],
        height = dimensions[2],
        shift = {0,0},
        scale = 0.5,
  ...
  data:extend({
    {
      ...
      selectable_in_game = false,
      picture = data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-rails-"..i..".png",
        width = 192,
        height = 128,
        shift = {0,0},
        scale = 0.5,
  ...
  data:extend({
    {
      ...
      selectable_in_game = false,
      picture = data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-shunt-"..i..".png",
        width = 256,
        height = 192,
        shift = {0,0},
        scale = 0.5,
...
data:extend({
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-1.png",
          width = 960,
          height = 512,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-1-shadow.png",
          width = 1024,
          height = 448,
          shift = {2,-1.5},
          scale = 0.5,q
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-2.png",
          width = 1280,
          height = 320,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-2-shadow.png",
          width = 1280,
          height = 320,
          shift = {1,0.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-3.png",
          width = 1280,
          height = 512,
          shift = {-1,-0.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-3-shadow.png",
          width = 1216,
          height = 448,
          shift = {0,0},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-4.png",
          width = 640,
          height = 576,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-4-shadow.png",
          width = 704,
          height = 576,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-5.png",
          width = 256,
          height = 256,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-5-shadow.png",
          width = 320,
          height = 192,
          shift = {-0.5,0.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-6.png",
          width = 384,
          height = 256,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-6-shadow.png",
          width = 384,
          height = 256,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-7.png",
          width = 448,
          height = 384,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-7-shadow.png",
          width = 448,
          height = 320,
          shift = {-0.5,0.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-8.png",
          width = 640,
          height = 832,
          shift = {-0.5, 0.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-8-shadow.png",
          width = 640,
          height = 832,
          shift = {-0.5, 1.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-9.png",
          width = 320,
          height = 704,
          shift = {0,-1},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-9-shadow.png",
          width = 384,
          height = 704,
          shift = {0.5,0},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-10.png",
          width = 320,
          height = 512,
          shift = {0.5,0},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-10-shadow.png",
          width = 320,
          height = 512,
          shift = {1.5,0},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-11.png",
          width = 256,
          height = 384,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-11-shadow.png",
          width = 256,
          height = 320,
          shift = {0,1.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-12.png",
          width = 832,
          height = 896,
          shift = {-1.5,-0.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-12-shadow.png",
          width = 896,
          height = 960,
          shift = {-1,0},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-13.png",
          width = 1344,
          height = 640,
          shift = {-0.5,3},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-13-shadow.png",
          width = 1280,
          height = 640,
          shift = {1,3},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-14-a-shadow.png",
          width = 832,
          height = 2176,
          shift = {-0.5,1},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-14-b.png",
          width = 2048,
          height = 704,
          shift = {2.5,3.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/fragment-14-b-shadow.png",
          width = 2048,
          height = 704,
          shift = {2.5,3.5},
          scale = 0.5,
  ...
  -- addons
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-1.png",
          width = 384,
          height = 256,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-1-shadow.png",
          width = 320,
          height = 128,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-2.png",
          width = 256,
          height = 320,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-2-shadow.png",
          width = 256,
          height = 128,
          shift = {-1,2},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-3.png",
          width = 256,
          height = 320,
          shift = middle_shift({{-3, -3}, {1, 2}}) ,
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-3-shadow.png",
          width = 128,
          height = 192,
          shift = {-1.5,1},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-4.png",
          width = 320,
          height = 192,
          shift = {0.5,-1.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-4-shadow.png",
          width = 128,
          height = 64,
          shift = {1,-1.5},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-5.png",
          width = 320,
          height = 192,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-5-shadow.png",
          width = 192,
          height = 128,
          shift = {2.5,-1},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-6.png",
          width = 256,
          height = 320,
          shift = {1, -0.5},
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-6-shadow.png",
          width = 192,
          height = 256,
          shift = {2.5,0},
          scale = 0.5,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-7.png",
          width = 256,
          height = 320,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-7-shadow.png",
          width = 192,
          height = 256,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-8.png",
          width = 384,
          height = 256,
          shift = middle_shift({{-3, -1}, {3, 3}}),
          scale = 0.5,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/lock-addon-8-shadow.png",
          width = 384,
          height = 192,
  ...
  },
  {
    ...
    picture = {
      layers = {
        data_util.auto_sr_hr({
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform.png",
          width = 704,
          height = 384,
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-shadow.png",
          width = 768,
          height = 192,
          shift = {0.5,0.5},
          scale = 0.5,
  ...
  },
  {
    ...
    pictures = {
      blank_image,
      data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-button-left.png",
        width = 52,
        height = 48,
        shift = {0,0},
        scale = 0.5,
  ...
  },
  {
    ...
    pictures = {
      blank_image,
      data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-button-middle.png",
        width = 54,
        height = 48,
        shift = {0,0},
        scale = 0.5,
  ...
  },
  {
    ...
    pictures = {
      blank_image,
      data_util.auto_sr_hr({
        filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-button-right.png",
        width = 48,
        height = 48,
        shift = {0,0},
        scale = 0.5,
  ...
  },
  {
    ...
    selectable_in_game = false,
    picture = data_util.auto_sr_hr({
      filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-indicator-green.png",
      width = 14,
      height = 26,
      shift = {0,0},
      scale = 0.5,
  ...
  },
  {
    ...
    selectable_in_game = false,
    picture = data_util.auto_sr_hr({
      filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-indicator-yellow.png",
      width = 14,
      height = 26,
      shift = {0,0},
      scale = 0.5,
  ...
  },
  {
    ...
    selectable_in_game = false,
    picture = data_util.auto_sr_hr({
      filename = "__space-exploration-graphics__/graphics/entity/gate/hr/platform-indicator-red.png",
      width = 14,
      height = 26,
      shift = {0,0},
      scale = 0.5,
  ...
  },
  {
    ...
    energy_source = {
      ...
      input_flow_limit = "11GW", -- total when all active (values over 60GW won't work)
    ...
    energy_usage = "10GW", -- platform + 1x per lock + 1x for final energy spike final activation.
    flags = {
      "placeable-player",
      "player-creation",
      "hidden",
