...
data:extend({
  {
    ...
    base = {
      layers = {
        data_util.auto_sr_hr({
          direction_count = 1,
          filename = "__space-exploration-graphics-3__/graphics/entity/supercharger/hr/supercharger.png",
          width = 256,
          height = 320,
          frame_count = 1,
          shift = { 0, -0.5 },
        ...
        data_util.auto_sr_hr({
          draw_as_shadow = true,
          direction_count = 1,
          filename = "__space-exploration-graphics-3__/graphics/entity/supercharger/hr/supercharger-shadow.png",
          width = 298,
          height = 165,
          frame_count = 1,
          shift = { 0.3, 0.8 },
    ...
    charging_energy = settings.startup["se-supercharger-individual-charge-rate"].value.."MW",
    ...
    drawing_box = { { -1.65, -1.65 - 1.5 }, {1.65, 1.65 + 0.5 } },
