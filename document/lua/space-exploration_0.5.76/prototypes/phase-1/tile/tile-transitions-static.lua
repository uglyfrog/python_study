  ...
  return {
        {
          inner_corner = {
            ...
            hr_version = {
              count = 8,
              line_length = 8,
              picture = "__space-exploration-graphics__/graphics/terrain/water-transitions/hr/cliff.png",
              scale = 0.5,
              tall = true,
              x = 0,
              y = 0
  ...
  return {
        {
          inner_corner = {
            ...
            hr_version = {
              count = 3,
              line_length = 3,
              picture = "__space-exploration-graphics__/graphics/terrain/water-transitions/hr/cliff-transition.png",
              scale = 0.5,
              tall = true,
              x = 0,
              y = 0
