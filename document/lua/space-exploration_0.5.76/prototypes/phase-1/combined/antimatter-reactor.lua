...
data:extend({
  {
    ...
    picture =
    {
      ...
      {
        {
          filename = "__space-exploration-graphics-3__/graphics/entity/antimatter-reactor/reactor.png",
          width = 160,
          height = 160,
          shift = { -0.03125, -0.1875 },
          hr_version = {
            filename = "__space-exploration-graphics-3__/graphics/entity/antimatter-reactor/hr-reactor.png",
            width = 320,
            height = 320,
            scale = 0.5,
            shift = { -0.03125, -0.1875 }
    ...
    {
      filename = "__space-exploration-graphics-3__/graphics/entity/antimatter-reactor/reactor-lights-color.png",
      width = 160,
      height = 160,
      shift = { -0.03125, -0.1875 },
      blend_mode = "additive",
      hr_version =
      {
        filename = "__space-exploration-graphics-3__/graphics/entity/antimatter-reactor/hr-reactor-lights-color.png",
        width = 320,
        height = 320,
        scale = 0.5,
        shift = { -0.03125, -0.1875 },
...
for _, version in pairs(long_versions) do
  ...
  table.insert(data.raw.technology[data_util.mod_prefix.."processing-naquium"].effects,
