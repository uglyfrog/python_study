...
data_util.tech_add_prerequisites("kr-matter-processing", {data_util.mod_prefix .. "space-matter-fusion", data_util.mod_prefix .. "deep-space-science-pack-1"})
  ...
  data:extend({
    {
      ...
      icons = {
        { icon = "__Krastorio2__/graphics/technologies/backgrounds/matter.png", icon_size = 256},
