...
UniverseRaw.universe = {
  ...
  space_zones = { -- other places in the same 2d layer as stars, mostly asteroid fields: 44
    { name = "Asteroidia" },
...
UniverseRaw.vitamelange_moons = {
  { name="Freyr", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --1
  { name="Bigrid", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --2
  { name="Eostre", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --3
  { name="Daisy", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --4
  { name="Ver", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --5
  { name="Jura", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --6
  { name="Buttercup", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --7
  { name="Eiar", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --8
  { name="Morityema", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --9
  { name="Gardinia", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --10
  { name="Shire", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --11
  { name="Mossgarden", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --12
  { name="Fern", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --13
  { name="Lilly", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --14
  { name="Rose", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --15
  { name="Tulip", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --16
  { name="Everglade", radius_multiplier = 0.8, primary_resource="se-vitamelange", tags={"enemy_low", "temperature_bland", "aux_very_low", "moisture_high", "trees_high", "water_med"} }, --17
}
...
UniverseRaw.unassigned_planets_or_moons = {
  {name="Mirage ", tags={"temperature_wild", "enemy_low", "water_med", "moisture_med", "aux_very_high", "trees_med"},
    primary_resource="iron-ore",
    preset_resource_bias={["uranium-ore"] = 0.03, ["crude-oil"] = 0.02, ["coal"] = 0.01},
    biome_replacements={ -- yellow, purple, green,
      {replace={"all-vegetation", "dirt-purple", "dirt-violet", "dirt-red", "dirt-brown", "dirt-tan", "dirt-dustyrose", "dirt-beige", "dirt-cream", "dirt-black", "dirt-grey", "dirt-white", "dirt-aubergine"}, with="vegetation-blue"},
      {replace={"sand-purple", "sand-violet", "sand-red", "sand-brown"}, with="sand-black"},
      {replace={"sand-tan", "sand-dustyrose", "sand-beige", "sand-cream", "sand-grey", "sand-aubergine"}, with="sand-white"},
      {replace={"all-volcanic"}, with="volcanic-blue"}
    }
  }, -- Shylo132
  {name="Noveria", tags={"temperature_frozen", "enemy_high", "water_high", "moisture_high", "aux_very_high", "trees_low"}, primary_resource="se-beryllium-ore", preset_resource_bias={["crude-oil"] = 0.99}}, -- Luckay
  {name="Vorlon", tags={"temperature_midrange", "enemy_none", "water_med", "moisture_med", "aux_med", "trees_low"}, primary_resource="se-iridium-ore",
    biome_replacements={ -- yellow, purple, green,
      {replace={"vegetation-blue", "dirt-cream" }, with="vegetation-yellow"},
      {replace={"vegetation-red" }, with="vegetation-olive"},
      {replace={"vegetation-orange", "all-frozen"}, with="vegetation-violet"},
      {replace={"vegetation-turquoise", }, with="vegetation-purple"},
      {replace={"dirt-violet", "dirt-brown", "dirt-red"}, with="dirt-purple"},
      {replace={"dirt-beige", "dirt-black", "dirt-grey", "dirt-white", "dirt-dustyrose"}, with="dirt-tan"},
      {replace={"sand-brown"}, with="sand-aubergine"},
      {replace={"sand-violet", "sand-black", "sand-red"}, with="sand-purple"},
      {replace={"sand-beige", "sand-grey", "sand-white", "sand-dustyrose"}, with="sand-tan"},
      {replace={"all-volcanic"}, with="volcanic-purple"} }
  }, -- SirVorlon
  ...
  {name="Katalos", tags={"temperature_extreme", "enemy_max", "water_med", "moisture_max", "aux_low", "moisture_high", "cliff_low", "trees_med"},
    primary_resource="se-beryllium-ore", preset_resource_bias={["se-cryonite"] = 0.99, ["se-vulcanite"] = 0.98, ["iron-ore"] = 0.02, ["stone"] = 0.01},
    biome_replacements={ -- yellow, purple, green,
      {replace={"vegetation-violet", "vegetation-purple", "vegetation-mauve", "vegetation-blue"}, with="vegetation-green"},
      {replace={"dirt-violet", "dirt-purple", "dirt-aubergine"}, with="dirt-brown"},
      {replace={"sand-violet", "sand-purple", "sand-aubergine"}, with="sand-brown"},
      {replace={"volcanic-purple", "volcanic-blue"}, with="volcanic-orange"} }
  }, -- PeterHan5
